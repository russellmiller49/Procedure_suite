#!/usr/bin/env python3
"""Diff two reporter seed-path evaluation reports."""
...
from app.common.reporter_seed_eval import build_seed_path_comparison_report, maybe_write_json
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = build_seed_path_comparison_report(

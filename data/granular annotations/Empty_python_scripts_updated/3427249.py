...
Source JSON: data/knowledge/patient_note_texts/3427249.json
"""
...
e1 = [
    ...
    {"label": "PROC_METHOD", **get_span(t1, "Microwave", 1)},
    {"label": "PROC_ACTION", **get_span(t1, "Ablation", 1)},
    {"label": "DEV_INSTRUMENT", **get_span(t1, "Probe", 1)},
...
e2 = [
    ...
    {"label": "PROC_METHOD", **get_span(t2, "Microwave", 1)},
    ...
    {"label": "PROC_METHOD", **get_span(t2, "microwave", 1)},
    {"label": "DEV_INSTRUMENT", **get_span(t2, "antenna", 1)},
    {"label": "PROC_METHOD", **get_span(t2, "Microwave", 2)},
...
e3 = [
    ...
    {"label": "PROC_METHOD", **get_span(t3, "Microwave", 1)},
...
e4 = [
    {"label": "PROC_METHOD", **get_span(t4, "Microwave", 1)},
    {"label": "PROC_ACTION", **get_span(t4, "Ablation", 1)},
    {"label": "ANAT_LUNG_LOC", **get_span(t4, "RUL", 1)},
    {"label": "ANAT_LUNG_LOC", **get_span(t4, "anterior", 1)},
    ...
    {"label": "PROC_METHOD", **get_span(t4, "Microwave", 2)},
    {"label": "DEV_INSTRUMENT", **get_span(t4, "catheter", 1)},
...
e5 = [
    ...
    {"label": "PROC_METHOD", **get_span(t5, "microwave", 1)},
    {"label": "DEV_INSTRUMENT", **get_span(t5, "needle", 1)},
    {"label": "PROC_ACTION", **get_span(t5, "burned", 1)},
...
e6 = [
    {"label": "PROC_METHOD", **get_span(t6, "Bronchoscopic", 1)},
    {"label": "PROC_METHOD", **get_span(t6, "microwave", 1)},
...
e7 = [
    ...
    {"label": "ANAT_LUNG_LOC", **get_span(t7, "anterior segment", 1)},
    {"label": "PROC_METHOD", **get_span(t7, "Microwave", 1)},
    ...
    {"label": "PROC_ACTION", **get_span(t7, "destroyed", 1)},
...
e10 = [
    ...
    {"label": "PROC_METHOD", **get_span(t10, "Bronchoscopic", 1)},
    {"label": "PROC_METHOD", **get_span(t10, "microwave", 1)},

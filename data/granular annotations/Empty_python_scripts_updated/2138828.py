...
# Add the scripts directory to the python path so we can import the utility
...
entities_2 = [
    ...
    {"label": "DEV_INSTRUMENT", **get_span(text_2, "antenna", 1)},
    {"label": "MEAS_ENERGY", **get_span(text_2, "60 Watts", 1)},
    {"label": "MEAS_TIME", **get_span(text_2, "6 minutes", 1)},
    {"label": "OBS_LESION", **get_span(text_2, "lesion", 2)},
]
...
entities_8 = [
    ...
    {"label": "DEV_INSTRUMENT", **get_span(text_8, "probe", 1)},
...
entities_9 = [
    ...
    {"label": "DEV_INSTRUMENT", **get_span(text_9, "antenna", 1)},
...
entities_10 = [
    ...
    {"label": "PROC_METHOD", **get_span(text_10, "ENB", 1)},
    {"label": "PROC_METHOD", **get_span(text_10, "navigation", 1)},
    ...
    {"label": "DEV_INSTRUMENT", **get_span(text_10, "probe", 1)},
    {"label": "MEAS_SIZE", **get_span(text_10, "14mm", 1)},
    {"label": "DEV_INSTRUMENT", **get_span(text_10, "antenna", 1)},
    {"label": "PROC_ACTION", **get_span(text_10, "Ablation", 2)},

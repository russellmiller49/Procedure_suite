...
e2 = [
    {"label": "PROC_ACTION", **get_span(t2, "Bronchoscopic Microwave Ablation", 1)},
...
e6 = [
    {"label": "PROC_ACTION", **get_span(t6, "Bronchoscopic microwave ablation", 1)},
...
e9 = [
    {"label": "PROC_ACTION", **get_span(t9, "Bronchoscopic tumor destruction", 1)},
...
e10 = [
    ...
    {"label": "PROC_ACTION", **get_span(t10, "Bronchoscopic microwave ablation", 1)},

...
entities_1 = [
    ...
    {"label": "DEV_NEEDLE", **get_span(text_1, "Aspiration needle", 2)},
    {"label": "MEAS_COUNT", **get_span(text_1, "3", 2)},

    {"label": "DEV_INSTRUMENT", **get_span(text_1, "Cytology brushings", 1)}, # Context implies the tool/action yielding brushings
    ...
    {"label": "OUTCOME_COMPLICATION", **get_span(text_1, "pneumothorax", 1)}, # Excluded, but typically labeled as the complication entity

    # Summary
    {"label": "PROC_METHOD", **get_span(text_1, "EBUS-guided", 1)},
    {"label": "PROC_METHOD", **get_span(text_1, "Robotic navigation", 1)},
    {"label": "PROC_ACTION", **get_span(text_1, "Tissue acquisition", 2)},

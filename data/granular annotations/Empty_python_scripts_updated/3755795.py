...
entities_3755795 = [
    ...
    {"label": "DEV_NEEDLE", **get_span(text_3755795, "Aspiration needle", 2)}, # 2nd occurrence (first in Seg 1)
    {"label": "SPECIMEN", **get_span(text_3755795, "Lavage fluid", 1)},
    {"label": "ANAT_LUNG_LOC", **get_span(text_3755795, "RUL", 3)}, # 3rd occurrence (RUL anterior x2, extracted from RUL)
    ...
    {"label": "SPECIMEN", **get_span(text_3755795, "Lavage", 2)}, # 2nd occurrence (Lavage fluid, Lavage dispatched)
    ...
    {"label": "PROC_METHOD", **get_span(text_3755795, "Robotic navigation", 2)},

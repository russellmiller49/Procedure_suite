...
e10 = [
    ...
    {"label": "ANAT_AIRWAY", **get_span(t10, "Trachea", 2)}, # "Trachea" in "visualized portion of the trachea" and "clean out the Trachea"
    {"label": "ANAT_AIRWAY", **get_span(t10, "main carina", 1)}, # Not present? Text says "The carina is sharp". Using "carina"

...
entities_2165517 = [
    ...
    # Post Procedure
    {"label": "ANAT_AIRWAY", **get_span(text_2165517, "Airways", 2)}, # "Airways inspected"
    ...
    {"label": "PROC_METHOD", **get_span(text_2165517, "robotic", 3)}, # 1: platform, 2: navigation, 3: bronchoscopy
    {"label": "PROC_ACTION", **get_span(text_2165517, "bronchoscopy", 2)}, # 1: Bronch procedure note, 2: here? Or usually implicit. 
    {"label": "ANAT_LUNG_LOC", **get_span(text_2165517, "peripheral lung", 1)},
    {"label": "PROC_ACTION", **get_span(text_2165517, "biopsy", 2)},
]

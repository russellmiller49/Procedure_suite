...
def get_span(text, term, occurrence=1):
    ...
    Args:
        ...
        term (str): The substring to find (case-sensitive).
        occurrence (int): Which occurrence to find (1-based).
    Returns:
        dict: {"text": term, "start": int, "end": int}
    """
    start = -1
...
e1 = [
    ...
    {"label": "OBS_FINDING",      **get_span(t1, "ablation zone", 1)},
...
e6 = [
    {"label": "PROC_ACTION",      **get_span(t6, "Bronchoscopic", 1)},
...
e9 = [
    {"label": "PROC_ACTION",      **get_span(t9, "Bronchoscopic", 1)},
    {"label": "OBS_LESION",       **get_span(t9, "tumor", 1)},
    {"label": "PROC_ACTION",      **get_span(t9, "destruction", 1)},
    {"label": "PROC_METHOD",      **get_span(t9, "Microwave energy", 1)},
...
e10 = [
    ...
    {"label": "PROC_ACTION",      **get_span(t10, "Bronchoscopic", 1)},
    ...
    {"label": "PROC_METHOD",      **get_span(t10, "superDimension", 1)},

...
entities_1 = [
    ...
    {"label": "ANAT_LN_STATION", **get_span(text_1, "4R", 2)}, # 1st is in '10R', 2nd is standalone '4R' -- Note: Python find finds substrings. '4R' might be inside '10R' (No, 0R != 4R). 
                                                                # Let's check text: "10R, 7, 2R, 4R". 
                                                                # '4R' is distinct. occurrence=1 is safe.
    ...
    {"label": "MEAS_COUNT",      **get_span(text_1, "7", 2)}, # "7" in "Stations... 7" is occ1, "biopsies: 7" is occ2
    {"label": "PROC_ACTION",     **get_span(text_1, "TBNA", 2)},
    {"label": "MEAS_COUNT",      **get_span(text_1, "3", 2)}, # "ASA Class: 3" is occ1. "TBNA passes: 3" is occ2.
    {"label": "PROC_ACTION",     **get_span(text_1, "Brushings", 1)},
    {"label": "MEAS_COUNT",      **get_span(text_1, "2", 2)}, # "2R" might trigger? "2R" contains "2". 
                                                              # "Stations... 2R". "Brushings: 2". 
                                                              # occ1="2" in "2R"? Yes. occ2="2" in "Brushings: 2".

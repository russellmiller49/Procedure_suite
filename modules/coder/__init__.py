...
IMPORTANT:
- `modules.coder.engine` is a **deprecated** legacy pipeline and imports heavy NLP deps
  (spaCy/medspaCy/UMLS tooling) at import-time.
- The primary supported entry point is `modules.coder.application.coding_service.CodingService`.

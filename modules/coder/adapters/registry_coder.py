...
Usage:
    from modules.registry.ml import ActionPredictor, ClinicalActions
    from modules.coder.adapters.registry_coder import RegistryBasedCoder
...
from modules.registry.ml.models import ClinicalActions

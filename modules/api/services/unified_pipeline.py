...
from modules.api.schemas import CodeSuggestionSummary, UnifiedProcessRequest, UnifiedProcessResponse
...
from modules.registry.application.registry_service import RegistryExtractionResult, RegistryService

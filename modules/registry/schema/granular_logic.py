...
`modules.registry.schema_granular` and now operates on types defined in
`modules.registry.schema.granular_models`.
"""
...
from modules.registry.schema.granular_models import EBUSStationDetail, EnhancedRegistryGranularData

#!/usr/bin/env python3
"""
Tests for Registry Data Preparation Module

Run with:
    pytest test_registry_data_prep.py -v
    
Or standalone:
    python test_registry_data_prep.py
"""
...
SAMPLE_EMPTY_REGISTRY = {
    "note_text": """This is a procedure note with no registry data present in the extraction.
    The bronchoscopy was performed successfully but no structured data was captured.
...
class TestLabelCoverage:
    ...
    def test_all_30_labels_present(self):
        ...
        # Bronchoscopy: 23
        bronch_labels = [l for l in ALL_PROCEDURE_LABELS if l in [
        ...
        assert len(bronch_labels) == 23
        
        # Pleural: 7
        pleural_labels = [l for l in ALL_PROCEDURE_LABELS if l in [
            "thoracentesis", "chest_tube", "ipc", "medical_thoracoscopy",
            "pleurodesis", "pleural_biopsy", "fibrinolytic_therapy"
        ]]
        assert len(pleural_labels) == 7
